...
public class AliasesJson {
  ...
  @NotNull public final AliasNextPage nextPage;
  @NotNull public final Long size;
  @NotNull public final List<AliasJson> contents;

  public AliasesJson(
      Long page, @Nullable Long nextPage, @NotNull Long size, @NotNull List<AliasJson> contents) {
    this.page = page;
    this.nextPage =
        nextPage == null ? AliasNextPage.finalPage() : AliasNextPage.middlePage(nextPage);
    this.size = size;
  ...
  public static AliasesJson from(
      Aliases aliases, Function<? super AliasName, ? extends String> uriResolver) {
    List<AliasJson> contents =
        aliases
            .aliases
            .stream()
